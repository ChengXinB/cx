...
<div id="login-wrapper" class="png_bg">
  <div id="login-top">
    <h1>BBS后台登陆</h1>
    <!-- Logo (221px width) -->
    <a href="#"><img id="logo" src="${pageContext.request.contextPath}/resources/images/logo.png" alt="Simpla Admin logo" /></a> </div>
  <!-- End #logn-top -->
  <div id="login-content">
    <form action="${pageContext.request.contextPath }/manager/person_login.action" method="post">
      <div class="notification information png_bg">
        <div> 该界面无法注册！ </div>
      </div>
      <p>
        <label>用 &nbsp;  户  &nbsp;名</label>
        <input class="text-input" type="text" name="p_username"/>
      </p>
      <div class="clear"></div>
      <p>
        <label>&nbsp;&nbsp;密 &nbsp;  码</label>
        <input class="text-input" type="password" name="p_password"/>
      </p>
      <div class="clear"></div>
      <div class="clear"></div>
      <p>
